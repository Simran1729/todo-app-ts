...
router.post('/signup', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user) {
        ...
        yield newUser.save();
        const token = jsonwebtoken_1.default.sign({ id: newUser._id }, index_1.secretKey, { expiresIn: '1h' });
...
router.post('/login', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user) {
        const token = jsonwebtoken_1.default.sign({ id: user._id }, index_1.secretKey, { expiresIn: '1h' });
